...
#define STRING_CONFIG_H_AUTHOR "(GB3 V4.1.5 PRO)" // Who made the changes.
...
// Define this to set a custom name for your generic Mendel,
 #define CUSTOM_MENDEL_NAME "Pellet Bot 5000"
...
#define HEATER_1_MAXTEMP 20000
#define HEATER_2_MAXTEMP 20000
...
#define HOMING_FEEDRATE {2500, 2500, 250, 0}  // set the homing speeds (mm/min)

// default settings

#define DEFAULT_AXIS_STEPS_PER_UNIT   {118.52,118.52,4031.5,1000} // default steps per unit for Ultimaker
...
// For the other hotends it is their distance from the extruder 0 hotend.
 #define EXTRUDER_OFFSET_X {0.0, 55.00} // (in mm) for each extruder, offset of the hotend on the X axis
...
#define CHANGE_FILAMENT_TEMP    210
//LCD and SD support
