...
static void lcd_prepare_menu()
{
    ...
    MENU_ITEM(gcode, "Home Z", PSTR("G28 Z0"));
...
static void Change_out_Filament_0()
{
	...
	active_extruder = 0;
	change_filament_triggered_by_user = true;
	currentMenu = lcd_status_screen;
	enquecommand("M600");
}
...
static void Change_out_Filament_1()
{
	active_extruder = 1;
	change_filament_triggered_by_user = true;
	currentMenu = lcd_status_screen;
...
static void Change_out_Filament_2()
{
	active_extruder = 2;
	change_filament_triggered_by_user = true;
	currentMenu = lcd_status_screen;
...
#if defined(HEATER_0_PIN) && HEATER_0_PIN > -1
	MENU_ITEM(function, MSG_FILAMENTCHANGE " 1", Change_out_Filament_0);
#endif

#if defined(HEATER_1_PIN) && HEATER_1_PIN > -1
	MENU_ITEM(function, MSG_FILAMENTCHANGE " 2", Change_out_Filament_1);
#endif

#if defined(HEATER_2_PIN) && HEATER_2_PIN > -1
	MENU_ITEM(function, MSG_FILAMENTCHANGE " 3", Change_out_Filament_2);
#endif
...
static void lcd_move_menu()
{
    START_MENU();
    MENU_ITEM(back, MSG_PREPARE, lcd_prepare_menu);
    MENU_ITEM(submenu, MSG_MOVE_10MM, lcd_move_menu_5mm);
...
static void lcd_control_motion_menu()
{
    ...
    #if EXTRUDERS > 1
    MENU_ITEM_EDIT(float52, "T1X Offset", &extruder_offset[X_AXIS][1], -60, 60);
    MENU_ITEM_EDIT(float52, "T1Y Offset", &extruder_offset[Y_AXIS][1], -5, 5);
    #endif // EXTRUDERS > 1
